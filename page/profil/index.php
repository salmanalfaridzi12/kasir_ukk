        ...
        <div class="col-xl-8 col-lg-7">
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#ubah_profil">Edit Profil</button>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="page/profil/edit-profil.php" method="post" enctype="multipart/form-data">
                    ...
                    <button type="submit" name="simpan_profil" id="simpan_profil" class="btn btn-primary">Simpan Profil</button>
                </form>
                <!-- akhir body -->
            </div>
            <!-- Modal footer -->
